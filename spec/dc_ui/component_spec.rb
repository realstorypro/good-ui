...
describe GoodUi::Component, 'component creation' do
  it 'it can be created' do
    component = GoodUi::Component.new({})
    expect(component).to be_a_kind_of(GoodUi::Component)
  end
end

describe GoodUi::Component, 'default component abilities' do
  before(:each) do
  ...
  it 'is an instance of component' do
    expect(@component).to be_an_instance_of(GoodUi::Component)
  end
...
describe GoodUi::Component, 'custom default component abilities' do
  before(:each) do
    @utils = GoodUi::Utilities.instance
  end
